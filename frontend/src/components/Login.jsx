            ...
            <div className="bg-white p-8 rounded-xl shadow-lg w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input type="email" required className="w-full p-2.5 border rounded-lg outline-none focus:ring-1 focus:ring-blue-500"
                            onChange={(e) => setCredentials({...credentials, email: e.target.value})} />
                    </div>
                    <div>
                        <label className="block text-xs font-bold text-gray-600 uppercase mb-1">Password</label>
                        <input type="password" required className="w-full p-2.5 border rounded-lg outline-none focus:ring-1 focus:ring-blue-500"
