...
const ForgotPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const msg = typeof err === 'string' ? err : 'Unable to process reset request.';
            setMessage(msg);
            toast.error(msg);
        }
    };
            ...
            <div className="relative z-10 w-full max-w-md overflow-hidden rounded-4xl border border-white/10 bg-[#0E1014]/72 shadow-[0_30px_90px_rgba(0,0,0,0.45)] backdrop-blur-2xl">
                ...
                <div className="relative p-6 sm:p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        {message && (
                            <div className="rounded-[20px] border border-emerald-400/20 bg-emerald-500/10 px-4 py-3 text-sm font-medium text-emerald-200 backdrop-blur-xl">
                                {message}
                            </div>
                        )}
